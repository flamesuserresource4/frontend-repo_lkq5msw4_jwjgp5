    ...
    <section className="bg-[#F9FAF9]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <span className="inline-flex items-center rounded-full bg-[#E4F5EC] px-3 py-1 text-xs font-medium text-[#1A3C34] ring-1 ring-[#7CC79F]/30">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-3">
              <a href="#signup" className="inline-flex items-center justify-center rounded-full bg-[#7CC79F] px-6 py-3 text-white font-semibold shadow-sm shadow-[#7CC79F]/25 hover:brightness-95 transition">
                Start For Free
              </a>
            ...
            <div className="mt-8 flex items-center gap-4 text-gray-500 text-sm">
              <div className="h-8 w-8 rounded-full bg-[#E4F5EC] ring-1 ring-[#7CC79F]/30" />
              <div className="h-8 w-8 rounded-full bg-[#E4F5EC] ring-1 ring-[#7CC79F]/30" />
              <div className="h-8 w-8 rounded-full bg-[#E4F5EC] ring-1 ring-[#7CC79F]/30" />
          ...
          <div>
            <div className="relative rounded-xl border border-[#7CC79F]/40 bg-white p-2 shadow-sm">
              <div className="rounded-lg bg-[#E4F5EC] p-2">
                <div className="aspect-[16/10] w-full rounded-md bg-white ring-1 ring-[#7CC79F]/30 p-4 grid grid-rows-[auto,1fr] gap-4">
                  <div className="flex items-center gap-2">
                    <div className="h-2.5 w-2.5 rounded-full bg-[#7CC79F]" />
                    <div className="h-2.5 w-2.5 rounded-full bg-[#7CC79F]/70" />
                    <div className="h-2.5 w-2.5 rounded-full bg-[#7CC79F]/40" />
                  </div>
